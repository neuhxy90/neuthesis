...
%---------------------------------------------------------------------------%
% Please use xe-bib-xe-xe to compile. This command ensures the SimHei and Content outline.
\documentclass[printcopy,review,fontset=windows]{Style/neuthesis}%
%- Multiple optional arguments:
%- [<singlesided|doublesided|printcopy>]% set one or two sided eprint or print
%- [<review|print>]% set review or final print version
